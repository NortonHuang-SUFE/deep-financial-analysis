...
def create_task_output_dir(output_dir: str = "./out") -> str:
    ...
    Args:
        output_dir: Base output directory. Relative paths are resolved from the
            workspace root. A timestamped child directory is reused for the task.

    Returns:
        Workspace-relative path of the task output directory.
    """
...
def write_markdown_report(
    ...
    Args:
        ...
        output_dir: Base output directory resolved from the workspace root.

    Returns:
        Workspace-relative path of the written markdown file.
    """
    out_dir = _timestamped_output_dir(output_dir)
...
def write_json_artifact(
    ...
    Returns:
        Workspace-relative path of the written JSON file.
    """
    try:
