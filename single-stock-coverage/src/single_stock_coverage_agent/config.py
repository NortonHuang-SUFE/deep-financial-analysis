"""Configuration loader for the Single Stock Coverage agent.

Merge order:
  single-stock-coverage/config.yaml < workspace-root .env < process environment

The workspace root is the parent of the single-stock-coverage project directory.
